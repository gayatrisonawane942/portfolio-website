  ...
  return (
    <nav>
      <div className="hidden lg:flex lg:items-center lg:gap-x-12">
       ...
       <Link href="#education" className="no-underline text-gray-950 hover:text-primary-500">
  Education
</Link>
        <Link href="#about" className="no-underline text-gray-950 hover:text-primary-500">
          About
        </Link>
        <Link href="#skills" className="no-underline text-gray-950 hover:text-primary-500">
          Skills
        </Link>
        <Link href="#experience" className="no-underline text-gray-950 hover:text-primary-500">
  Internship
</Link>
        <Link href="#process" className="no-underline text-gray-950 hover:text-primary-500">
          Process
        </Link>
        
        <Link href="#portfolio" className="no-underline text-gray-950 hover:text-primary-500">
          Portfolio
        </Link>
        <Link href="#Certifications" className="no-underline text-gray-950 hover:text-primary-500">
          Certifications
        </Link>
        <Link href="#services" className="no-underline text-gray-950 hover:text-primary-500">
          Services
        </Link>
